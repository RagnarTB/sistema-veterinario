      ...
      <form [formGroup]="form" (ngSubmit)="onSubmit()" class="login-form">
        ...
        <div class="grid grid-cols-2 gap-4">
          <div class="form-group mb-4">
            ...
            <input id="nombre" type="text" formControlName="nombre" class="form-control" placeholder="Ej. Juan"(input)="f['nombre'].markAsTouched()">
            @if (f['nombre'].touched && f['nombre'].hasError('required')) {<span class="form-error">El nombre es obligatorio</span>
            }
          </div>
          <div class="form-group mb-4">
            <label class="form-label" for="apellido">Apellidos</label>
            <input id="apellido" type="text" formControlName="apellido" class="form-control" placeholder="Ej. Pérez" (input)="f['apellido'].markAsTouched()">
